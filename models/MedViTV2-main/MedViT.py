...
import os as _os
_NA_BIAS = _os.environ.get("MEDVIT_NA_BIAS", "1") == "1"
if not _NA_BIAS:
    print("[MedViT] rel_pos_bias DISABLED (MEDVIT_NA_BIAS=0) -> deterministic NA backward")
...
class LFP(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, path_dropout=0.2,
        ...
        extra_args = {"rel_pos_bias": _NA_BIAS} if is_natten_post_017 else {"bias": _NA_BIAS}
