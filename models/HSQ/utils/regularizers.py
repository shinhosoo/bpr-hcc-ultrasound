...
class MaxNorm_via_PGD():
    ...
    def setPerLayerThresh(self, model):
        ...
        for curLayer in [model.classifier[1].weight, model.classifier[1].bias,
                         model.head0[1].weight,model.head0[1].bias,
                         model.head1[1].weight, model.head1[1].bias,
                         model.head2[1].weight, model.head2[1].bias,
                         model.head3[1].weight, model.head3[1].bias,
                         model.liver_backbone.head.weight, model.liver_backbone.head.bias,
                         model.tumor_backbone.head.weight, model.tumor_backbone.head.bias,
                         model.original_backbone.head.projection.weight, model.original_backbone.head.projection.bias,
                         ]: #here we only apply MaxNorm over the last two layers
    ...
    def PGD(self, model):
        ...
        for i, curLayer in enumerate([model.classifier[1].weight, model.classifier[1].bias,
                         model.head0[1].weight,model.head0[1].bias,
                         model.head1[1].weight, model.head1[1].bias,
                         model.head2[1].weight, model.head2[1].bias,
                         model.head3[1].weight, model.head3[1].bias,
                         model.liver_backbone.head.weight, model.liver_backbone.head.bias,
                         model.tumor_backbone.head.weight, model.tumor_backbone.head.bias,
                         model.original_backbone.head.projection.weight, model.original_backbone.head.projection.bias,]): #here we only apply MaxNorm over the last two layers
            curparam = curLayer.data
