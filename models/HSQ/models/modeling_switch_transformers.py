...
class SwitchTransformersTop1Router(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> Tuple:
        ...
        #router_probs,router_logits：[B,Seq_len,num_experts]
        expert_index = torch.argmax(router_probs, dim=-1)#取出概率最大的那个
        ...
        #expert_index:[B,Seq_len,num_experts],num_experts是onehot编码
...
class SwitchTransformersSparseMLP(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        #router_mask是[B,Seq_len,num_experts],num_experts直接是专家的编号，例如[50,1024,3]
        #router_probs 是[B, Seq_len, probs]
