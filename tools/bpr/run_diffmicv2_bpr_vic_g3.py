...
if BPR_HOOK == "attn":
    ...
    print(f"[bpr-hook] ortho — orthogonal-subspace conditioning (z_inst 분산 보존 곱셈 + z_cls BPR 가산)")

else:
    raise ValueError(f"BPR_HOOK={BPR_HOOK} 미지원 (attn | prelin4 | enc512 | enc512_local | xweight | xweight_bn | xweight_aux | dual_gl | dual2ch | ortho 중 택1)")
