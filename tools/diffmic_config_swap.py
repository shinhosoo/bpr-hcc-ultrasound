...
ap.add_argument("--arch", default=None,
                help="set model.arch (encoder backbone: resnet18|resnet50|densenet121|vit)")
ap.add_argument("--aux_ckpt_path", default=None,
                help="set model.aux_ckpt_path (DiffMICv2 Stage-2 DCG 로드용)")
...
if a.arch:
    cfg_plain.setdefault("model", {})
    cfg_plain["model"]["arch"] = a.arch
if a.aux_ckpt_path:
    cfg_plain.setdefault("model", {})
    cfg_plain["model"]["aux_ckpt_path"] = a.aux_ckpt_path
