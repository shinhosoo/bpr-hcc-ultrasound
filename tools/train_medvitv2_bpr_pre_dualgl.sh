...
export BPR_HOOK="${BPR_HOOK:-global}"  # global | aux
...
export BPR_PROTO_REFRESH="${BPR_PROTO_REFRESH:-1}"
export BPR_PROTO_BS="${BPR_PROTO_BS:-64}"
export BPR_PROTO_EMA="${BPR_PROTO_EMA:-0.0}"  # 0=off, >0=EMA
